...
import { featureCards } from "@/components/config/homeData";
    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="bw-container py-20 md:py-32 text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl mb-12 max-w-2xl mx-auto text-[var(--color-text-secondary)] leading-relaxed">
          ...
          <span className="block mt-2 text-[var(--color-text-muted)] text-lg">
            No bank connections required. Completely private.
          </span>
        </p>
      ...
      <div className="bw-container py-24 border-t border-[var(--color-border)]">
        <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          {featureCards.map((f) => (
            <div
              key={f.title}
              className="bw-card p-8 hover:-translate-y-2 transition-transform duration-300 group border border-[var(--color-border)] hover:border-[var(--color-primary)]/30"
            >
              ...
              <h3 className="text-xl font-bold mb-3 text-[var(--color-text)] group-hover:text-[var(--color-primary)] transition-colors">
                {f.title}
              </h3>
